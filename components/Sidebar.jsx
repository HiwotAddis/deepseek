...
const Sidebar = ({ expand, setExpand }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 msx-md:absolute max-md:h-screen ${
        ...
        >
          ...
          <div
            className={`absolute -top-60 pb-8 ${
              !expand && "-right-40"
            } opacity-0 group-hover:opacity-100 transition hidden group-hover:block`}
          >
